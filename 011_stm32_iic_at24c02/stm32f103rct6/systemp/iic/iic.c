...
/*
	函数名称：	void I2C_GPIO_Config(void)
	函数功能：	I2C I/O配置
	函数形参：	无
	返 回 值：	无
	硬件接口：
...
/*
	函数名称：	void I2C_Mode_Configu(void)
	函数功能：	I2C 工作模式配置
	函数形参：	无
	返 回 值：	无
*/
...
//  EEPROM_ERROR("I2C 等待超时!errorCode = %d",errorCode);
	usart_sendStr(USART1, "I2C 等待超时!errorCode =");
	usart_sendByte(USART1, errorCode);
